...
module.exports.updateUser = (req, res) => {
  ...
  if (typeof updateInfo.id == "number") {
    ...
    fs.writeFile("MOCK_DATA.json", updatedUsers, (err) => {
      // error checking
      if (err) throw err;
      console.log("New user added");
      res.send("updated");
...
module.exports.deleteUser = (req, res) => {
  ...
  if (typeof deletedID == "number") {
    ...
    fs.writeFile("MOCK_DATA.json", restUsers, (err) => {
      // error checking
      if (err) throw err;
      console.log("New user added");
